...
export default async function handler(
    ...
    const url = "https://api.twitter.com/2/tweets/search/recent?query=conversation_id:1565054846956445697&expansions=attachments.media_keys&media.fields=height,url&tweet.fields=in_reply_to_user_id,author_id,created_at,conversation_id,attachments&max_results=100&sort_order=recency"
